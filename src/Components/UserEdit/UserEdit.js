...
export class UserEdit extends React.Component{
    ...
    componentDidMount(){
        if(this.state.numero==="1"){
            ...
            console.log(this.state.NombreApellido)
        }else{
    ...
    getTexto=(user)=>{
        ...
        .onSnapshot(snap=>{
            this.setState({
                NombreApellido: snap.data().NombreApellido,
                ci: snap.data().ci,
                ...
                <div className="col-lg-6">
                    <form action='/biblioteca/Main/view-Users'>
                        ...
                        <div className="form-group">
                            ...
                            <input autoComplete="off"  value={this.state.NombreApellido} onChange={this.handleChange} type="text" className="form-control" id="firtsName" placeholder="Nombre Completo" required/>
                        </div>
                        <div className="form-group">
