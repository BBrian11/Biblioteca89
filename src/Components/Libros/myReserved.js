    ...
    function resLibrosUser() {
        return(
            <div className="main">
                ...
                <a href="/biblioteca/Main/Libros"><button id="back" className="btn btn-dark btn-lg">Atras</button></a>
            </div>
        )
    }
    ...
    return(
        <div className="row">
            ...
            <div className="col-lg-10">
                ...
                {localStorage.getItem("User")==="adminSuper"?reservedLibros():localStorage.getItem("User")?resLibrosUser():noExists()}
            </div>
            <div className="col-lg-1"></div>
        </div>
    )
